...
export const AuroraBackground = ({
  ...
  return (
    <div
      className={cn(
        "transition-bg relative w-full flex h-[20rem] flex-col items-center justify-center text-slate-950 ",
        className,
      )}
      {...props}
    >
      <div
        ...
        style={
          {
            "--aurora":
              "repeating-linear-gradient(100deg,#fff7ed_5%,#fef3c7_10%,#fde68a_15%,#facc15_20%,#fff7ed_25%)",
            "--dark-gradient":
      ...
      opacity-100 blur-[10px] invert filter will-change-transform
      [--aurora:repeating-linear-gradient(100deg,var(--golden-100)_5%,var(--golden-200)_10%,var(--golden-300)_15%,var(--golden-400)_20%,var(--golden-100)_25%)]
